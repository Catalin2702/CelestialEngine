...
#ifndef CE_CORE_HUB_EVENTS_I_KEYBOARDEVENTHUBDISPATCHER_HPP
#define CE_CORE_HUB_EVENTS_I_KEYBOARDEVENTHUBDISPATCHER_HPP
...
#endif //CE_CORE_HUB_EVENTS_I_KEYBOARDEVENTHUBDISPATCHER_HPP
