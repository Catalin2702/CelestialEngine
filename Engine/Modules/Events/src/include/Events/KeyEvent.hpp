 ...
 *			It uses the KeyboardKeyCodes enum defined in the Types namespace, which provides a standardized set of key codes across the application.
 */
using KeyType = Types::KeyboardKeyCode;
