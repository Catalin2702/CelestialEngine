...
/**
 * @namespace CE::Events
 * @brief Event system for handling application-level events
 * @details Provides event classes for window resizing, closing, and application lifecycle events.
 *			These events are generated by the application or windowing system and can be handled
 *			by layers or other event listeners to respond to changes in the application state.
 */
namespace CE::Events {
